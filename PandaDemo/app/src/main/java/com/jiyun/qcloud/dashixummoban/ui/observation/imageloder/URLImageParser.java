package com.jiyun.qcloud.dashixummoban.ui.observation.imageloder;
...
public class URLImageParser implements Html.ImageGetter {
    ...
    public Drawable getDrawable(String source) {
        ...
        instance.init(ImageLoaderConfiguration.createDefault(App.mBaseActivity));

        instance.loadImage(source, new SimpleImageLoadingListener() {
            @Override
